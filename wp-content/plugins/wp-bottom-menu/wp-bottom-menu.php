...
define( 'WP_BOTTOM_MENU_VERSION', '1.4.1' );
            ...
            <?php endif; ?>
                    ...
                    <div class="wp-bottom-menu-icon-wrapper">
                        ...
                        <?php if(get_option( 'wpbottommenu_iconset', 'fontawesome' ) == 'fontawesome'): ?>
                            <?php if($wpbm_item_url == 'https://kedroshop.ru/wishlist/'): ?>
                                <div class="page-top__label wishlist_products_counter_number" style="height: calc(var(--wpbottommenu-icon-size) * .75); width: calc(var(--wpbottommenu-icon-size) * .75);font-size: calc(var(--wpbottommenu-icon-size) * .5); right: -8px">0</div>
                            <?php endif; ?>
